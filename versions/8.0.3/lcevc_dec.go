...
// LLibraryLcevcdecPrepare performs the coded preparation manipulation for lcevc-dec on FFmpeg 8.0.3.
func LLibraryLcevcdecPrepare(plan *shared.LibraryPreparationPlan) {
	plan.FfmpegVersion = "8.0.3"
	plan.LibraryId = "lcevc-dec"
	plan.VersionSpecificGoFile = "versions/8.0.3/lcevc_dec.go"
