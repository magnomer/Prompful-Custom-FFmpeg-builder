...
// LLibraryLcevcdecPrepare performs the coded preparation manipulation for lcevc-dec on FFmpeg 9.0.1.
func LLibraryLcevcdecPrepare(plan *shared.LPreparationPlan) {
	plan.FfmpegVersion = "9.0.1"
	plan.LibraryId = "lcevc-dec"
	plan.VersionSpecificGoFile = "versions/9.0.1/lcevc_dec.go"
